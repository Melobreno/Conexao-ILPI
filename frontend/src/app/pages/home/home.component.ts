...
@Component({
  ...
  template: `
      ...
      <div class="section flex flex-col md:flex-row items-center gap-8 py-16">
        <div class="flex-1 text-center md:text-left">
          ...
          <div class="flex flex-wrap gap-3 justify-center md:justify-start">
            <a routerLink="/doacoes" class="btn-primary">
              Quero Doar
            </a>
        ...
        <div class="flex-1 flex justify-center">
          <div class="w-64 h-64 md:w-80 md:h-80 rounded-3xl bg-white/10 flex items-center justify-center text-8xl shadow-lg"
               aria-hidden="true">
            🏡
          </div>
        </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
        <article class="card text-center">
          ...
          <p class="text-sm text-warm-gray">
            Assistência médica, nutricional e psicossocial para cada residente.
          </p>
        </article>
        <article class="card text-center">
          <div class="text-4xl mb-3" aria-hidden="true">🤝</div>
          ...
          <p class="text-sm text-warm-gray">
            Voluntários e doadores que transformam vidas com pequenos gestos.
          </p>
        </article>
        <article class="card text-center">
          <div class="text-4xl mb-3" aria-hidden="true">🌟</div>
          ...
          <p class="text-sm text-warm-gray">
            Cada idoso merece respeito, atenção e um sorriso todos os dias.
          </p>
        </article>
      </div>
    </section>
    ...
    <section class="bg-sand" aria-labelledby="routine-heading">
      <div class="section">
        <h2 id="routine-heading" class="text-3xl font-bold text-olive mb-4 text-center">
          A Rotina do Lar
        </h2>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
          @for (item of routine; track item.emoji) {
            <div class="card py-6">
              <div class="text-3xl mb-2" [attr.aria-hidden]="true">{{ item.emoji }}</div>
    ...
    <section class="section text-center" aria-labelledby="cta-heading">
      <h2 id="cta-heading" class="text-3xl font-bold text-olive mb-3">
      ...
      <div class="flex flex-wrap justify-center gap-4">
        <a routerLink="/doacoes" class="btn-primary text-lg px-8">
          Ver Necessidades de Doação
        </a>
        <a routerLink="/voluntariado" class="btn-ghost text-lg px-8">
